...
export async function GET(req: NextRequest) {
  ...
  try {
    ...
    // Função auxiliar para buscar nome pelo cpf
    ...
    // Preenche os nomes nas transações feitas
    ...
    // Preenche os nomes nas transferências recebidas, adicionando flag isReceived
